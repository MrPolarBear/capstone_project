...
###################################
#Content Recc input and use below
###################################
content_recc_input = st.text_input("For content recc, copy and paste in from above which show you'd like a recommendation on based on: ")
st.write("The list below is our recommendation for the show you searched for: ", content_recc_input)
st.write(recommend_all_sim(content_recc_input,25, vectorized_no_movie, nomovie_title, df_anime_nomovie))
